<template>
  <div>
    <svg t="1508738709248" @click='click' class="screenfull-svg" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2069" width="32" height="32">
    ...
    methods: {
      click() {
        if (!screenfull.enabled) {
          this.$message({message: this.$t('main.message.browsercannot'), type: 'warning'});
          return false;
        }
        screenfull.toggle();
      }
