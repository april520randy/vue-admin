<template>
  <div class="tags-view-container">
    ...
    <ul class="contextmenu" v-show="visible" :style="{left:left+'px',top:top+'px'}">
      <li @click="closeSelectedTag(selectedTag)">{{$t('main.label.close')}}</li>
      <li @click="closeOthersTags">{{$t('main.label.closeothers')}}</li>
      <li @click="closeAllTags">{{$t('main.label.closeall')}}</li>
    </ul>
  </div>
</template>
